...
commands.add(command.info, {
  params: '^info\\s?(.*)?',
  usage: "info",
  description: "Shows information about BotsAintSimp.",
  name: "info"
});
...
commands.add(command.join, {
  params: '^join\\s?(.*)?',
  usage: "join",
  description: "Allows BotsAintSimp to respond to every commands in a conversation.",
  name: "join",
  adminOnly: true
});
...
commands.add(command.leave, {
  params: '^leave\\s?(.*)?',
  usage: "leave",
  description: "Prevents BotsAintSimp from responding to every commands in a conversation.",
  name: "leave",
  adminOnly: true
});
